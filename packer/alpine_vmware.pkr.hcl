...
build {
  ...
  provisioner "shell" {
    inline = [
      ...
      "wget https://aci-github.cisco.com/camrossi/akb/archive/master.zip",
      "unzip master.zip",
      "rm master.zip",
      "pip3 install -r akb-master/requirements.txt",
      "pip3 install https://github.com/datacenter/pyaci/archive/master.zip",
      "wget http://10.67.185.120/akb/akb_ubuntu21_template.ova -O akb-master/terraform/static/vm_templates/akb_ubuntu21_template.ova",
      "wget https://releases.hashicorp.com/terraform/1.1.3/terraform_1.1.3_linux_amd64.zip",
      "unzip terraform_1.1.3_linux_amd64.zip  -d /bin",
      "rm terraform_1.1.3_linux_amd64.zip",
      "rc-update add local default",
      "echo 'python3 /root/akb-master/terraform/appflask.py &' > /etc/local.d/akb.start",
