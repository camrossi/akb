...
build {
  ...
  provisioner "shell" {
    inline = [
      ...
      "unzip master.zip",
      "rm master.zip",
      "pip3 install -r akb/requirements.txt",
      "pip3 install https://github.com/datacenter/pyaci/archive/master.zip",
      "wget http://10.67.185.120/akb/akb_ubuntu21_template.ova  akb/terraform/static/vm_templates/",
      "wget https://releases.hashicorp.com/terraform/1.1.3/terraform_1.1.3_linux_amd64.zip",
      "unzip terraform_1.1.3_linux_amd64.zip  -d /bin",
      "rc-update add local default",
      "echo 'python3 /root/akb/terraform/appflask.py &' > /etc/local.d/akb.start",
